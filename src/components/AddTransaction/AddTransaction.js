                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <FormControl>
                            ...
                            <Input placeholder="Enter Transaction description" w={'full'} name="description" type="text" onChange={handleFormChange} />
                        </FormControl>
                        <FormControl>
                            <FormLabel>Enter Amount</FormLabel>
                            <Input placeholder="Enter Transaction amount" name="amount"
                                type="number" onChange={handleFormChange} />
                        </FormControl>
                        <RadioGroup mt={'5'} value={value} onChange={setValue}>
                            ...
                            <Radio
                                checked={formData.type === 'expense'} ml={'5'}
